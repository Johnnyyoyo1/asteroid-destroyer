...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetTopBorderContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetTopBorderContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setBorderTop(eventsFunctionContext.getArgument("Value"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetLeftBorderContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetLeftBorderContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setBorderLeft(eventsFunctionContext.getArgument("Value"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetBottomBorderContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetBottomBorderContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setBorderBottom(eventsFunctionContext.getArgument("Value"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetRightBorderContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetRightBorderContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setBorderRight(eventsFunctionContext.getArgument("Value"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetTriggerOffsetContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrapPhysics.ScreenWrapPhysics.prototype.SetTriggerOffsetContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setTriggerOffset(eventsFunctionContext.getArgument("Value"));
}
}}
